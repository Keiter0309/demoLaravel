...
<div class="bg-white h-screen flex justify-center items-center">
    <div class="bg-gray-100 rounded shadow-lg p-8 max-w-md w-full">
        ...
        <form action="" method="POST">
            ...
            <div class="mt-3">
                <button
                    class="transition delay-150 ease-in-out bg-blue-500 hover:bg-indigo-500 hover:-translate-y-1 hover:scale-105 duration-300 rounded w-full p-3 text-white">Reset Password</button>
            </div>
        </form>
    </div>
</div>
